...
# 475 SNPs were significant. Nearly all of these are in the Ace1 region.
...
# There are no clumps aside from Ace1.
...
# Just a scattering across the genome
