...
study.pop = 'Baguida_gambiae_Delta'
...
clump1 <- list(clump.id = 'clump1',
               snp.ids = as.character(top.snps[approx.pos %in% paste('2L', 485:486, sep = ':'), ][order(Pos), ]$ID),
               chrom = '2L',
               start = 48450000,
               end = 48650000
)
...
clump2 <- list(clump.id = 'clump2',
               snp.ids = as.character(top.snps[approx.pos %in% paste('2R', 192:193, sep = ':'), ][order(Pos), ]$ID),
               chrom = '2R',
               start = 19150000,
               end = 19350000
)
...
clump3 <- list(clump.id = 'clump3',
               snp.ids = as.character(top.snps[approx.pos %in% paste('2R', 197, sep = ':'), ][order(Pos), ]$ID),
               chrom = '2R',
               start = 19650000,
               end = 19750000
)
...
clump4 <- list(clump.id = 'clump4',
               snp.ids = as.character(top.snps[approx.pos %in% paste('2R', 245, sep = ':'), ][order(Pos), ]$ID),
               chrom = '2R',
               start = 24450000,
               end = 24550000
)
...
clump5 <- list(clump.id = 'clump5',
               snp.ids = as.character(top.snps[approx.pos %in% paste('2R', 335:336, sep = ':'), ][order(Pos), ]$ID),
               chrom = '2R',
               start = 33450000,
               end = 33650000
)
...
clump6 <- list(clump.ids = 'clump6',
               snp.ids = as.character(top.snps[approx.pos %in% paste('2R', 340, sep = ':'), ][order(Pos), ]$ID),
               chrom = '2R',
               start = 33950000,
               end = 34050000
)
...
clump7 <- list(clump.ids = 'clump7',
               snp.ids = as.character(top.snps[approx.pos == '2R:342', ][order(Pos), ]$ID),
               chrom = '2R',
               start = 34150000,
               end = 34250000
)
...
clump8 <- list(clump.id = 'clump8',
               snp.ids = as.character(top.snps[approx.pos %in% paste('2R', 76:78, sep = ':'), ][order(Pos), ]$ID),
               chrom = '2R',
               start = 7550000,
               end = 7850000
)
...
clump9 <- list(clump.id = 'clump9',
               snp.ids = as.character(top.snps[approx.pos %in% paste('2R', 84, sep = ':'), ][order(Pos), ]$ID),
               chrom = '2R',
               start = 8350000,
               end = 8450000
)
...
clump10 <- list(clump.id = 'clump10',
                snp.ids = as.character(top.snps[approx.pos == '3L:103', ][order(Pos), ]$ID),
                chrom = '3L',
                start = 10250000,
                end = 10350000
)
...
clump11 <- list(clump.id = 'clump11',
                snp.ids = as.character(top.snps[approx.pos == '3R:101', ][order(Pos), ]$ID),
                chrom = '3R',
                start = 10050000,
                end = 10150000
)
